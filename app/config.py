...
class Config(object):
    ...
    VIDEO_DATA_PATH="{}/../videos/".format(APP_ROOT)
    PROCESSING_TIMELAPSE = 6000
...
class Development(Config):
    ...
    DB_NAME = os.getenv('DB_NAME', 'corona')
    MONGO_URI = f'''mongodb://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}'''
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_USER', "preventiecovid19@gmail.com")
    MAIL_USERNAME = os.getenv('MAIL_USER', "preventiecovid19@gmail.com")
    MAIL_PASSWORD = os.getenv('MAIL_PASSWORD', "Corona19")
